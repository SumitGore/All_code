...
public class demo5 {
    ...
    public static void main(String[] args) throws EncryptedDocumentException, InvalidFormatException {
        ...
        try {
            ...
            String filepath = "D:\\CRF_Customer_TagsValues1.xlsx";
            Workbook newWorkbook = openOrCreateWorkbook(filepath);
            
            addDataToExcel(newWorkbook, customerTagMap);
...
//    private static Workbook openOrCreateWorkbook(String filePath) throws IOException, EncryptedDocumentException, InvalidFormatException {
//        File file = new File(filePath);
//
//        if (file.exists()) {
//            // If the file exists, open the existing workbook
//            return WorkbookFactory.create(file);
//        } else {
//            // If the file does not exist, create a new workbook
//            return new XSSFWorkbook(); // Use HSSFWorkbook for .xls format
//        }
//    }
    ...
    private static void addDataToExcel(Workbook newWorkbook, Map<String,Map<List<String>,List<String>>> customerTagMap) throws IOException {
    	 ...
    	 for (Map.Entry<String, Map<List<String>,List<String>>> entry : customerTagMap.entrySet()) {
             ...
             Map<List<String>,List<String>> tagsEntry = entry.getValue();
	             ...
	             for (Map.Entry<List<String>,List<String>> tagValues : tagsEntry.entrySet()) {
				    ...
				    String modifiedCustomerName = customerName.replaceAll("[^a-zA-Z0-9]+", "_");
				        ...
				        if (!"na".equals(custId)) {
				          ...
				          System.out.println("device Id :  "+deviceIds);
				            for (int i = 0; i < deviceIds.size(); i++) {
					            ...
					            System.out.println("tagsssss: "+tagValuesAPI);
					            Sheet customerSheet;
					            ...
					            if (sheet==null) {
							    	...
							    	System.out.println("bhfgweilhgpiuhiuiehguih");
			                    ...
			                    System.out.println("tag1: "+tagValuesAPI);
			                    addToExcel(2, header1, tagValuesAPI);
			                    nxtRow++;
      ...
      // Save the changes back to the Excel file
         FileOutputStream fileOutputStream = new FileOutputStream("D:\\CRF _Customer_TagsValues1.xlsx");
