...
public class crfSitesOne {
    ...
    public static void main(String[] args) throws EncryptedDocumentException, InvalidFormatException {
        ...
        try {
            ...
            String filepath = "D:\\CRF_OneValues1.xlsx";
...
//					                	   tagValuesAPI.add(maxValue);
//					                   }
//						            }
				            	List<Object> tagValueList= new ArrayList<Object>();
						        for (String tagToCompare : tags) {
			            	    String maxTs = null;
			            	    Object maxValue = null;
			            	    ...
			            	    for (String deviceId : deviceIds) {
			            	      ...
			            	      //  System.out.println("device Values: " + deviceValues);
			            	            ...
			            	            if (key.equals(tagToCompare)) {
			            	                ...
			            	                if (keyNode.isArray() && keyNode.size() > 0) {
			            	                    ...
			            	                    if (!"null".equals(value)) {
			            	                         ...
			            	                         //   System.out.println( tagToCompare + " across all devices: " + currentMaxValue);
			            	                    } else {
			            	                        // System.out.println("Value for " + key + " is null, ignoring...");
			            	                    }
			            	                }
			            	            }
			            	        }
			            	       ...
			            	       //*********************maximum ts and first value************
//			            	        if (maxValue == null && currentMaxValue != null) {
//			            	            maxValue = currentMaxValue;
//			            	        } else if (currentMaxValue != null && maxTs != null && currentMaxTs != null &&
//			            	                   currentMaxTs.equals(maxTs) && (doubleValue.intValue() > (Integer) maxValue)) {
//			            	               maxValue = currentMaxValue;
//			            	        }
			            	    }
						      ...
						      //  System.out.println("value: "+tagValueList);
				                  ...
				                  //  header1.createCell(1).setCellValue(deviceName.get(i).replaceAll("\"", ""));
				                    ...
				                    addToExcel(1, header1, tagValueList, headingLen);
				                    nxtRow++;
				       }
				            else {
         ...
         FileOutputStream fileOutputStream = new FileOutputStream("D:\\CRF_OneValues1.xlsx");
